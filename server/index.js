...
//   console.log(chalk.bold.cyan("Note: Please enable the host (http://127.0.0.1:"+port+") in a new tab and authorize the connection by clicking Advanced->Proceed to 127.0.0.1 (unsafe)."));
// }).on('error',(err)=>{
//     if(err.code === 'EADDRINUSE')
//       console.log(chalk.bold.red(port + " port is already in use"));
// })
